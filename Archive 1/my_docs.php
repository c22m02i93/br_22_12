...
include 'head.php';
?>
<title>Закачка документов</title>
...
echo '<p style="color:#135B00; text-align: center">Документ <b>http://barysh-eparhia.ru/'.$uploadfile.'</b> успешно добавлен!</p><br />';
...
?>
	<TABLE CELLSPACING=3 CELLPADDING=2 width='400' align='center' border=0>
		...
		<TR><TD VALIGN=top> Выберите файл с компьютера
		</TD><TD> <input type=file name="uploadfile" required></TD></TR>
