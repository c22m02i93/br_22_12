...
$img = "FOTO_MINI/{$news['oblozka']}.jpg";
?>

<a href="news_show.php?data=<?= $news['data'] ?>" style="text-decoration:none; color:inherit;">
<div class="news-card">
    ...
    <div class="news-card-body">
        <div class="news-card-title"><?= $news['tema'] ?></div>
        <div class="news-card-meta">
            <span><?= $date_out ?></span>
            <span class="views"><img src="IMG/views.png"> <?= $news['views'] ?></span>
        </div>
