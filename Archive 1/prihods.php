...
echo '<ol>';
 mysql_connect("localhost", "host1409556", "0f7cd928"); 
$news_all = mysql_query("SELECT * FROM host1409556_barysh.prihods WHERE name LIKE '%Собор%'  AND blag = '$blag' ORDER BY name");
if (mysql_num_rows($news_all) > '0') {		echo '<p><span class="title" style="color:#5A5A5A"><b>Соборы</b></span></p>';
...
$news_all = mysql_query("SELECT * FROM host1409556_barysh.prihods WHERE name LIKE '%Храм%' AND blag = '$blag' ORDER BY name");
...
$news_all = mysql_query("SELECT * FROM host1409556_barysh.prihods WHERE name LIKE '%Часовня%' AND blag = '$blag' ORDER BY name");
if (mysql_num_rows($news_all) > '0') {
		echo '<p><span class="title" style="color:#5A5A5A"><b>Часовни</b></span></p>';
...
$news_all = mysql_query("SELECT * FROM host1409556_barysh.prihods WHERE blag = '$blag' AND (name LIKE '%дом %' OR name LIKE '%комната%')  ORDER BY name");
if (mysql_num_rows($news_all) > '0') {
		echo '<p><span class="title" style="color:#5A5A5A"><b>Молитвенные дома и комнаты</b></span></p>';
...
echo '<ol>';
 mysql_connect("localhost", "host1409556", "0f7cd928"); 
$news_all = mysql_query("SELECT * FROM host1409556_barysh.prihods WHERE name LIKE '%Собор%'  AND raion = '$raion' ORDER BY name");
if (mysql_num_rows($news_all) > '0') {		echo '<p><span class="title" style="color:#5A5A5A"><b>Соборы</b></span></p>';
...
$news_all = mysql_query("SELECT * FROM host1409556_barysh.prihods WHERE name LIKE '%Храм%' AND raion = '$raion' ORDER BY name");
if (mysql_num_rows($news_all) > '0') {
		echo '<p><span class="title" style="color:#5A5A5A"><b>Храмы</b></span></p>';
...
$news_all = mysql_query("SELECT * FROM host1409556_barysh.prihods WHERE name LIKE '%Часовня%' AND raion = '$raion' ORDER BY name");
if (mysql_num_rows($news_all) > '0') {
		echo '<p><span class="title" style="color:#5A5A5A"><b>Часовни</b></span></p>';
...
$news_all = mysql_query("SELECT * FROM host1409556_barysh.prihods WHERE raion = '$raion' AND (name LIKE '%дом %' OR name LIKE '%комната%')  ORDER BY name");
if (mysql_num_rows($news_all) > '0') {
		echo '<p><span class="title" style="color:#5A5A5A"><b>Молитвенные дома и комнаты</b></span></p>';
